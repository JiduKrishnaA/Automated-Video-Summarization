...
for key in d.keys():
    ...
    if key + '/time2' not in d:
        ...
        # Dataset already exists, decide whether to update or skip
        pass  # You can add your logic here if you want to update the existing dataset
